...
function LoginForm(props) {
    ...
    const handleLogin = async () => {
        ...
        else if(password.length<5)
        {
            ...
            await axios.post('https://secret-castle-58335.herokuapp.com/api/users/login',data)
                .then((res)=>{
                    setDisabled(false)
    ...
    return ( 
        <div className={styles.container}>
            ...
            <div>
                ...
                }} className={styles.left} onClick={()=>handleLogin()}><span>{disabled?'Logging in...':'Login'}</span></Button>
