...
const AccountInfo = (props) => {
  ...
  const validate = Yup.object({
    ...
    dob: Yup.date(),
    city: Yup.string().max(25, "*City name should be less than 25 chars"),
    country: Yup.string().max(
      25,
      "*Country name should be less that 25 characters"
    ),
  ...
  const handleOnSubmit = async (data) => {
    ...
    await axios
      .patch(
        `https://secret-castle-58335.herokuapp.com/api/users/${user._id}`,
        val
      )
      .then((res) => {
                ...
                {(formik) => (
                  <Form>
                    ...
                    <TextField
                      type="text"
                      name="college"
                      placeholder="enter your College/University/School name"
                      label="College"
                    ></TextField>
                    ...
                    <div className={styles.formField}>
                      ...
                      <Field
                        name="about"
                        as="textarea"
                        placeholder="write something about you in 100 words"
                      />
                      <ErrorMessage
                        name="about"
                        component="div"
